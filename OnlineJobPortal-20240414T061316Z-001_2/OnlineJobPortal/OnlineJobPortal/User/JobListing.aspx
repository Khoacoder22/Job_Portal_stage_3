<%@ Page Title="" Language="C#" MasterPageFile="~/User/user.Master" AutoEventWireup="true" CodeBehind="JobListing.aspx.cs" Inherits="OnlineJobPortal.User.About" %>
                                        ...
                                        <div class="single-job-items mb-30">
                                            ...
                                            <div class="items-link items-link2 f-right">
                                                ...
                                                <%--<span class="text-secondary">
                                                  ...
                                                  <%# RelativeDate(Convert.ToDateTime(Eval("LastDate"))) %>
